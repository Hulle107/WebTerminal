...
Guard.NonArray = (value, message = undefined) => {
    ...
    if (!Array.isArray(value)) throw new TypeError(message === undefined ? `Required value is not of type Array` : message);
...
Guard.NonBoolean = (value, message = undefined) => {
    ...
    if (typeof value !== 'boolean') throw new TypeError(message === undefined ? `Required value is not of type Boolean.` : message);
...
Guard.NonObject = (value, message = undefined) => {
    ...
    if (typeof value !== 'object') throw new TypeError(message === undefined ? `Required value is not of type Object.` : message);
...
Guard.NonNumber = (value, message = undefined) => {
    ...
    if (typeof value !== 'number') throw new TypeError(message === undefined ? `Required value is not of type Number.` : message);
...
Guard.NonString = (value, message = undefined) => {
    ...
    if (typeof value !== 'string') throw new TypeError(message === undefined ? `Required value is not of type String.` : message);
