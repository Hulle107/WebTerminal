...
class TerminalField {
    ...
    set backgroundColor(value) {
        Guard.NonInstanceOf(value, TerminalColor, `The value of the backgroundColor parameter got assigned a wrong type.`);
     ...
     */
    set character(value) {
        Guard.NonString(value, `The value of the character parameter got assigned a wrong type.`);
        Guard.NonChar(value, `The value of the character parameter was not a single char.`);
    ...
    set foregroundColor(value) {
        Guard.NonInstanceOf(value, TerminalColor, `The value of the foregroundColor parameter got assigned a wrong type.`);
