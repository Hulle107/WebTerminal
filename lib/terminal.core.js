...
class Terminal {
    ...
    MoveBufferArea(sourceArea, targetCoordinate, replace = this._createEmptyField()) {
        ...
        Guard.NonInstanceOf(replace.backgroundColor, TerminalColor, `The value of the replace.backgroundColor parameter got assigned a wrong type.`);
        Guard.NonInstanceOf(replace.foregroundColor, TerminalColor, `The value of the replace.foregroundColor parameter got assigned a wrong type.`);
